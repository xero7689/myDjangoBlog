...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('work_image', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Image.created'
        db.alter_column('work_image', 'created', self.gf('django.db.models.fields.DateTimeField')())
